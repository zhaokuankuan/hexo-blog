...
![这里写图片描述](/blog8/20180509172029526.png)
输入项目的目录结构和项目的名称，如图：
![这里写图片描述](/blog8/20180509172333830.png)
然后选择你需要导入的jar包，如下：
![这里写图片描述](/blog8/20180509172423241.png)
web是web项目的核心启动包，devtools是一个web项目的工具包。

**二.然后你的一个springboot项目便创建完成。**
如图我们可以创建这个项目的目录结构，但是需要注意一点的是，包的结构必须和TestApplication是在一级上。
 ![这里写图片描述](/blog8/20180509172740232.png)
...
```
**然后我们启动这个工程，然后访问一下！**
![这里写图片描述](/blog8/20180509173207746.png)
